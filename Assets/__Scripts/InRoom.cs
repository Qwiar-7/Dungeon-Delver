...
public class InRoom : MonoBehaviour
{
    ...
    static public Vector2[] DOORS = new Vector2[] { new Vector2(14.5f, 5.5f), new Vector2(8.0f, 9.5f),
                                                    new Vector2( 1.5f, 5.5f ), new Vector2( 8.0f, 1.5f)};
    ...
    public bool isInRoom
    {
        ...
        {
            Vector2 posIR = posInRoom;
            if (posIR.x < WALL + radius || posIR.x > ROOM_W - WALL - radius || posIR.y < WALL + radius
